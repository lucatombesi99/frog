...
public class MediumScene {
    ...
    public static ImageView life1,life2,life3,life4;
    ...
    public AnchorPane setScene() {
        ...
        Log firstLog6 = new Log(1, 400, 138, 1.5);
        Log firstLog2 = new Log(0, 250, 170, -1.5);
        Log firstLog7 = new Log(1, 450, 170, -1.5);
        Log firstLog8 = new Log(0, 300, 200, 1.5);
        Log firstLog3 = new Log(1, 500, 200, 1.5);
        Log firstLog9 = new Log(0, 350, 229, -1.5);
        Log firstLog4 = new Log(1, -100, 229, -1.5);
        Log firstLog10 =new Log(1, 400, 258, 1.5);
        Log firstLog5 = new Log(0, -50, 258, 1.5);
        Log firstLog11 = new Log(0, -50, 138, 1.5);
        Log firstLog12 = new Log(1,  0, 170, -1.5);
        Log firstLog16 = new Log(1,  500, 138, 1.5);
        Log firstLog17 = new Log(1,  650, 170, -1.5);
        Log firstLog18 = new Log(1,  -90, 200, 1.5);
        Log firstLog19 = new Log(1,  700, 229, -1.5);
        Log firstLog20 = new Log(1,  -140, 258, 1.5);
        ...
        Turtle tur3=new Turtle(200,198,1.5);
        Turtle tur4=new Turtle(250,229,-1.5);
        Turtle tur5=new Turtle(300,258,1.5);
        Turtle tur6=new Turtle(50,198,1.5);
        Turtle tur7=new Turtle(100,229,-1.5);
        Turtle tur8=new Turtle(150,258,1.5);
        ...
        //macchine
        Vehicle car1 = new Vehicle(1,  300, 321, -2.0);
        Vehicle truck1 = new Vehicle(2, 210,351, 1.5);
        Vehicle car2 = new Vehicle(1,  150, 382, -2.0);
        Vehicle bigTruck1 = new Vehicle(3, 75,413, 1.5);
        Vehicle car3 = new Vehicle(1,  250, 444, -2.0);
        Vehicle car4 = new Vehicle(1,  100, 321, -2.0);
        Vehicle truck2 = new Vehicle(2, 10,351, 1.5);
        Vehicle car5 = new Vehicle(1,  -50, 382, -2.0);
